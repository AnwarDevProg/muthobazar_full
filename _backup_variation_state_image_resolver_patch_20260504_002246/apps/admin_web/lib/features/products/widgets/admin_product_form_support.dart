  ...
  Widget _buildPreviewBox(BuildContext context) {
    if (widget.galleryFullOnly) {
      return _buildPreviewTile(
        ...
        status: _preparedImage == null
            ? 'Existing remote full image'
            : 'Local optimized full image - pending upload',
        extra: 'Gallery image saves only this full image URL/metadata.',
        height: 320,
        fit: BoxFit.contain,
      );
    }
  ...
  MBProductMedia _buildResult() {
    ...
    if (widget.galleryFullOnly) {
      return existing.copyWith(
        ...
        // Gallery images are full-image-only. Keep remote full URL for
        // existing images, or keep URLs empty when a local pending image will
        // be uploaded by the main Save Product button.
        ...
        originalWidth: null,
        clearOriginalWidth: true,
        originalHeight: null,
        clearOriginalHeight: true,
        originalSizeBytes: null,
        clearOriginalSizeBytes: true,
        cardWidth: null,
        clearCardWidth: true,
        cardHeight: null,
        ...
        thumbHeight: null,
        clearThumbHeight: true,
        thumbSizeBytes: null,
        clearThumbSizeBytes: true,
        tinyWidth: null,
        clearTinyWidth: true,
        tinyHeight: null,
        clearTinyHeight: true,
        tinySizeBytes: null,
        clearTinySizeBytes: true,
        fitMode: 'contain',
        clearCropAspectRatioX: true,
        clearCropAspectRatioY: true,
        clearCropWidth: true,
        clearCropHeight: true,
        clearCropSizeBytes: true,
        clearCropZoomScale: true,
        pendingOriginalBytes: prepared?.originalBytes,
        pendingFullBytes: prepared?.fullBytes,
        pendingCardBytes: prepared?.cardBytes,
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    widget.galleryFullOnly
                        ? 'Gallery image phase. Pick one image; only the optimized full image URL/metadata will be saved for gallery use.'
                ...
                _buildInfoRow(
                  ...
                  _preparedImage == null
                      ...
                      : (widget.galleryFullOnly
                          ? 'Local pending gallery full image. It will upload only after Save Product.'
                ...
                const SizedBox(height: 8),
                if (widget.galleryFullOnly && _preparedImage != null) ...[
                  _buildInfoRow(
                    'Full Pixels',
                ...
                ] else if (!widget.galleryFullOnly && _preparedImage != null) ...[
                  _buildInfoRow(
                    'Original Pixels',

...
class MBAdvancedBindingResolver {
  ...
  static String resolveImageUrl(
    ...
    switch (binding.trim()) {
      ...
      case MBAdvancedBindingKey.productResolvedOriginalImageUrl:
        return _resolveProductOriginalImageUrl(context.product, fallback: fallback);
  ...
  static String _resolveProductOriginalImageUrl(
    dynamic product, {
    required String fallback,
  }) {
    ...
    final media = _readFirstMediaUrl(
      product,
      const <String>['effectiveOriginalUrl', 'originalUrl', 'fullUrl', 'url'],
    );
  ...
  static String _resolveProductFullImageUrl(
    dynamic product, {
    required String fallback,
  }) {
    final direct = _readAny(
    ...
    final media = _readFirstMediaUrl(
      product,
      const <String>['effectiveFullUrl', 'fullUrl', 'url', 'cardUrl', 'thumbUrl'],
    );
    if (media.isNotEmpty) return media;
  ...
  static String _resolveProductCardImageUrl(
    ...
    final media = _readFirstMediaUrl(
      product,
      const <String>['effectiveCardUrl', 'cardUrl', 'fullUrl', 'url', 'thumbUrl'],
    );
    if (media.isNotEmpty) return media;
  ...
  static String _resolveProductThumbImageUrl(
    dynamic product, {
    required String fallback,
  }) {
    final direct = _readAny(
    ...
    final media = _readFirstMediaUrl(
      product,
      const <String>['effectiveThumbUrl', 'thumbUrl', 'cardUrl', 'fullUrl', 'url'],
    );
    if (media.isNotEmpty) return media;
  ...
  static String _resolveProductTinyImageUrl(
    dynamic product, {
    required String fallback,
  }) {
    final direct = _readAny(
    ...
    final media = _readFirstMediaUrl(
      product,
      const <String>['effectiveTinyUrl', 'tinyUrl', 'thumbUrl', 'cardUrl', 'fullUrl', 'url'],
    );
    if (media.isNotEmpty) return media;

    return _resolveProductThumbImageUrl(product, fallback: fallback);
  }

  static String _readFirstMediaUrl(
    dynamic source,
    List<String> fields,
  ) {
    try {
      ...
      if (mediaItems is Iterable && mediaItems.isNotEmpty) {
        for (final item in mediaItems) {
          for (final field in fields) {
            final value = _readString(item, field);
  ...
  static String _resolveVariationImageUrl(
    ...
    try {
      ...
      if (mediaItems is Iterable && mediaItems.isNotEmpty) {
        for (final item in mediaItems) {
          final card = _readAny(item, const <String>['effectiveCardUrl', 'cardUrl'], '');
          if (card.isNotEmpty) return card;
          final full = _readAny(item, const <String>['effectiveFullUrl', 'fullUrl', 'imageUrl', 'url'], '');
          if (full.isNotEmpty) return full;
          final thumb = _readAny(item, const <String>['effectiveThumbUrl', 'thumbUrl', 'thumbnailUrl'], '');
  ...
  static String _readFirstImageUrl(dynamic source) {
    final mediaUrl = _readFirstMediaUrl(
      source,
      const <String>['effectiveCardUrl', 'cardUrl', 'effectiveFullUrl', 'fullUrl', 'imageUrl', 'url', 'effectiveThumbUrl', 'thumbUrl'],
    );
    ...
    try {
      ...
      switch (fieldName) {
        ...
        case 'thumbnailUrl':
          ...
          break;
        case 'resolvedOriginalImageUrl':
          value = source.resolvedOriginalImageUrl;
          break;
        case 'resolvedFullImageUrl':
          value = source.resolvedFullImageUrl;
          break;
        ...
        case 'resolvedThumbImageUrl':
          ...
          break;
        case 'resolvedTinyImageUrl':
          value = source.resolvedTinyImageUrl;
          break;
        case 'imageUrl':
        ...
        case 'thumbUrl':
          ...
          break;
        case 'tinyUrl':
          value = source.tinyUrl;
          break;
        case 'effectiveOriginalUrl':
          value = source.effectiveOriginalUrl;
          break;
        case 'effectiveFullUrl':
          value = source.effectiveFullUrl;
          break;
        ...
        case 'effectiveThumbUrl':
          ...
          break;
        case 'effectiveTinyUrl':
          value = source.effectiveTinyUrl;
          break;
        case 'brandName':

// MB Product Card - horizontal03
//
// Family:
// Horizontal
//
// Purpose:
// A more action-heavy horizontal family variant built for quicker shopping
// decisions. This version emphasizes the CTA area more strongly than the
// other horizontal variants while still keeping the row footprint stable.
//
// Footprint:
// Full-width card.
// Short to medium horizontal footprint.
...
// 3. Price
// 4. CTA row
// 5. Limited support metadata
//
// Best Use Cases:
// Quick-buy lists, replenishment rows, repeat orders, checkout suggestions,
// and action-led recommendation strips.
//
// Behavior Notes:
// - More action-forward than horizontal01 and horizontal02.
// - Keeps content compact and buy-oriented.
// - Works well when add-to-cart is enabled.
// - Gracefully handles missing sale, brand, or subtitle data.
...
class MBProductCardHorizontal03 extends StatelessWidget {
  const MBProductCardHorizontal03({
    super.key,

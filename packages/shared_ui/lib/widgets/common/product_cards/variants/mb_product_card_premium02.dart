// MB Product Card - premium02
//
// Family:
// Premium
//
// Purpose:
// A cleaner luxury-retail premium family variant with stronger structure than
// premium01. This version keeps the half-width showcase footprint while making
// brand, price, and product hierarchy feel more polished and intentional.
//
// Footprint:
// Half-width card.
...
// 2. Brand cue
// 3. Product title
// 4. Premium price block
// 5. Calm support meta
//
// Best Use Cases:
// Branded electronics, beauty items, premium grocery, home lifestyle items,
// and curated higher-value product sections.
//
// Behavior Notes:
// - Cleaner and more structured than premium01.
// - Brand gets a stronger but still restrained role.
// - Keeps the premium family feeling calm and polished.
// - Gracefully handles missing brand, subtitle, sale, or support data.
...
class MBProductCardPremium02 extends StatelessWidget {
  const MBProductCardPremium02({
    super.key,

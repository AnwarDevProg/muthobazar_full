// MB Product Card - featured04
//
// Family:
// Featured
//
// Purpose:
// A brand-forward featured-family variant where the supporting identity of the
// product becomes more visible inside the featured layout. This version is good
// when the brand itself adds part of the hero value.
//
// Footprint:
// Full-width card.
// Tall footprint.
// Designed for high-importance section anchors.
//
// Visual Priority:
// 1. Product image
// 2. Brand / identity line
// 3. Product title
// 4. Price block
// 5. CTA / support metadata
//
// Best Use Cases:
// Branded hero rows, curated premium brands, beauty/electronics anchors,
// and featured spots where brand recognition matters.
//
// Behavior Notes:
// - More brand-led than featured01/02/03.
// - Still remains product-first overall.
// - Uses a clear upper identity cue.
// - Gracefully handles missing brand, subtitle, and sale data.
...
class MBProductCardFeatured04 extends StatelessWidget {
  const MBProductCardFeatured04({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final brandLine = _buildBrandLine(context);

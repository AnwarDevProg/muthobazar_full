// MB Product Card - promo05
//
// Family:
// Promo
//
// Purpose:
// A softer editorial promo-family variant that keeps the campaign feeling but
// lowers urgency and visual pressure. This version is useful when a promo row
// should feel curated and elegant rather than loud.
//
// Footprint:
// Full-width card.
// Medium to tall footprint.
// Designed for softer promotional sections.
//
// Visual Priority:
// 1. Product image
// 2. Product title
// 3. Soft campaign note
// 4. Price block
// 5. CTA / footer metadata
//
// Best Use Cases:
// Editorial campaign rows, lifestyle promotions, softer category landers,
// curated banners-with-products, and elegant seasonal sections.
//
// Behavior Notes:
// - Softest of the first Promo batch.
// - Lower urgency than promo01/02/03/04.
// - Keeps campaign presence but feels calmer.
// - Gracefully handles missing sale, subtitle, and campaign data.
...
class MBProductCardPromo05 extends StatelessWidget {
  const MBProductCardPromo05({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final note = _buildSoftNote(context);
  ...
  EdgeInsets _contentPadding() {
    ...
    final base = 16.0 * scale;
    return EdgeInsets.all(base.clamp(12.0, 28.0));
  }
  ...
  String? _softNoteText() {
    ...
    if (salePrice != null && salePrice < product.price) {
      ...
      return 'A quieter campaign moment with ৳${saved.toStringAsFixed(0)} in savings.';
    }
    if (product.isFeatured) return 'A softly curated campaign selection.';
    return 'A gentle promotional spotlight for this product.';
  }

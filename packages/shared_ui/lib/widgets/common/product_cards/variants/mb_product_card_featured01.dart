// MB Product Card - featured01
//
// Family:
// Featured
//
// Purpose:
// A full-width hero-style product card used to anchor a section with one
// stronger product presentation that feels more important than surrounding
// standard cards.
//
// Footprint:
// Full-width card.
// Tall footprint.
// Designed to dominate a section visually without becoming a pure marketing banner.
//
// Visual Priority:
// 1. Product image
// 2. Product title
// 3. Offer / highlight message
// 4. Current price
// 5. CTA cue or supporting detail
//
// Best Use Cases:
// Featured products, hero products, section anchors, strong campaign picks,
// premium electronics or signature grocery deals.
//
// Behavior Notes:
// - Must feel noticeably stronger than wide01.
// - Title may be slightly larger than standard cards.
// - Offer/highlight area may be present, but should stay product-focused.
// - Must work safely in bounded preview containers and scrollable layouts.
// - Must remain stable when only minimal product data is available.
...
class MBProductCardFeatured01 extends StatelessWidget {
  const MBProductCardFeatured01({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final highlight = _buildHighlightRow(context);
  ...
  Widget? _buildHighlightRow(BuildContext context) {

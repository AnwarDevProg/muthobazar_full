...
// - No drag/drop yet. Patch 2 will add drawer drag insertion + mouse move.
// - No keyboard control yet. Patch 3 will add arrow move/resize/delete.
  ...
  void _addVariant(MBAdvancedElementVariant variant) {
    ...
    final node = MBAdvancedDesignNode(
      ...
      position: variant.defaultPosition.copyWith(
        x: (variant.defaultPosition.x + offset).clamp(0.04, 0.96).toDouble(),
        y: (variant.defaultPosition.y + offset).clamp(0.04, 0.96).toDouble(),
        z: _nextLayerZ(),
      ),
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                const Text(
                  'Patch 1 active · 3-panel shell + JSON import/export + click selection',
                  style: TextStyle(

...
// Patch 1 middle responsive canvas.
//
// Purpose:
...
//
// Patch 2 will add drag/drop insertion and mouse drag movement.
    ...
    return Container(
      ...
      child: const Row(
        children: <Widget>[
          ...
          Text(
            'Click node to select · Empty click selects card',
            style: TextStyle(
              color: Color(0xFF747B8A),
              fontSize: 11,
              fontWeight: FontWeight.w700,
              ...
              for (final node in sortedNodes)
                if (node.visible)
                  _CanvasNodeWidget(
                    ...
                    scale: scale,
                    cardWidth: document.cardWidth * scale,
                    cardHeight: document.cardHeight * scale,

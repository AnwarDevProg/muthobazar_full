// MB Product Card - featured02
//
// Family:
// Featured
//
// Purpose:
// A cleaner featured-family variant that keeps the hero feel of featured01
// but makes the lower content area more retail-structured and easier to scan.
//
// Footprint:
// Full-width card.
// Tall footprint.
// Designed to anchor a section with one stronger product story.
//
// Visual Priority:
// 1. Product image
// 2. Product title
// 3. Highlight line
// 4. Price block
// 5. Support metadata / CTA
//
// Best Use Cases:
// Featured section anchors, premium grocery highlights, curated electronics,
// signature picks, and home-page hero rows.
//
// Behavior Notes:
// - Cleaner and more structured than featured01.
// - Keeps strong full-width hero behavior.
// - Uses a clearer lower content stack.
// - Gracefully handles missing highlight, sale, subtitle, or meta.
...
class MBProductCardFeatured02 extends StatelessWidget {
  const MBProductCardFeatured02({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final highlight = _buildHighlightChip(context);
  ...
  Widget? _buildHighlightChip(BuildContext context) {
    final text = _highlightText();
    if (text == null || text.isEmpty) {
      return null;
    }
  ...
  String? _highlightText() {
    if (product.isFeatured) {
      return 'Curated section highlight';
    }
    if (product.isBestSeller) {
      return 'Popular featured pick';
    }
    if (product.isFlashSale) {
      return 'Limited featured offer';
    }
    return 'Section spotlight';
  }

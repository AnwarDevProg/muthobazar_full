// MB Product Card - horizontal02
//
// Family:
// Horizontal
//
// Purpose:
// A cleaner retail-style horizontal family variant with stronger product
// structure than horizontal01. This version keeps the full-width row behavior
// but adds a tidier brand/value rhythm for clearer everyday browsing.
//
// Footprint:
// Full-width card.
...
// 1. Product image
// 2. Product title
// 3. Brand / subtitle line
// 4. Price row
// 5. Small support meta
//
// Best Use Cases:
// Daily recommendations, list-style rows, frequently bought items,
// reorder-style sections, and general browsing rows.
//
// Behavior Notes:
// - Cleaner and calmer than horizontal01.
// - Uses a slightly more structured upper content area.
// - Keeps actions optional and compact.
// - Gracefully handles missing brand, subtitle, or sale data.
...
class MBProductCardHorizontal02 extends StatelessWidget {
  const MBProductCardHorizontal02({
    super.key,

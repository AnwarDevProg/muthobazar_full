// MB Product Card - premium04
//
// Family:
// Premium
//
// Purpose:
// A brand-forward premium family variant where the label, maker, or premium
// line is more visible. This version is useful when the product’s brand plays
// a major role in desirability and trust.
//
// Footprint:
// Half-width card.
...
//
// Best Use Cases:
// Beauty brands, electronics, imported products, premium packaged items,
// and higher-trust branded merchandise.
//
// Behavior Notes:
// - More brand-led than premium01/02/03.
// - Still remains product-first overall.
// - Uses a stronger upper brand presentation.
...
class MBProductCardPremium04 extends StatelessWidget {
  const MBProductCardPremium04({
    super.key,
  ...
  Widget build(BuildContext context) {
    final brandHeader = _buildBrandHeader(context);
        ...
        child: Stack(
          children: <Widget>[
            Column(
              ...
              children: <Widget>[
                if (brandHeader != null) brandHeader,
                Padding(

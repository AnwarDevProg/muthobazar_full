// MB Product Card - featured03
//
// Family:
// Featured
//
// Purpose:
// A more image-rich featured-family variant that gives the media stronger
// storytelling weight while keeping the product content clean and premium.
//
// Footprint:
// Full-width card.
// Tall footprint.
// Designed to feel like a richer visual section anchor.
//
// Visual Priority:
// 1. Product image
// 2. Product title
...
//
// Best Use Cases:
// High-impact section heroes, premium collection anchors, curated seasonal
// rows, electronics highlights, and visually strong product stories.
//
// Behavior Notes:
// - More image-led than featured01 and featured02.
// - Keeps the product as the core message.
// - Uses softer, more cinematic lower content spacing.
// - Gracefully handles missing highlight, subtitle, or sale.
...
class MBProductCardFeatured03 extends StatelessWidget {
  const MBProductCardFeatured03({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final heroLine = _buildHeroLine(context);
  ...
  Widget? _buildHeroLine(BuildContext context) {
  ...
  String? _heroText() {
    if (product.isFeatured) {
      return 'Curated hero product';
    }
    if (product.isBestSeller) {
      return 'Popular spotlight choice';
    }
    if (product.isNewArrival) {
      return 'Freshly added highlight';
    }
    return 'Hero section product';
  }

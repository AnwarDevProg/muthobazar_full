// MB Product Card - premium03
//
// Family:
// Premium
//
// Purpose:
// An image-richer premium family variant that lets the product visual carry
// more of the premium feeling. This card is useful when the product image
// itself is strong enough to drive desirability.
//
// Footprint:
// Half-width card.
...
// 1. Product image
// 2. Product title
// 3. Premium price line
// 4. Brand / support line
// 5. Subtle CTA
//
// Best Use Cases:
// Beauty items, electronics, premium packaged foods, curated gift products,
// and sections where image quality is strong.
//
// Behavior Notes:
// - More image-led than premium01 and premium02.
// - Keeps premium styling restrained and elegant.
// - Works best when product media is strong.
// - Gracefully handles missing brand, sale, and subtitle data.
...
class MBProductCardPremium03 extends StatelessWidget {
  const MBProductCardPremium03({
    super.key,

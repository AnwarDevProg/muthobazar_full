// MB Product Card - compact03
//
// Family:
// Compact
//
// Purpose:
// A compact-family variant with a stronger quick-buy personality than compact01
// and compact02. This version is meant to feel slightly more shoppable at a
// glance by tightening the content stack and giving the lower section a more
// deliberate buy-focused rhythm.
//
// Footprint:
// Half-width card.
...
// 2. Product title
// 3. Final price
// 4. Buy cue / compact CTA row
// 5. Light metadata chips
//
// Best Use Cases:
// Daily essentials, grocery repeat items, pharmacy basics, home care items,
// and sections where fast buying matters more than storytelling.
//
// Behavior Notes:
// - Keeps the compact family footprint.
// - Feels more action-oriented than compact01 and more buy-focused than compact02.
// - Uses a compact bottom action row when actions are enabled.
// - Supports graceful fallback when brand, subtitle, sale, or stock signals are missing.
...
class MBProductCardCompact03 extends StatelessWidget {
  const MBProductCardCompact03({
    super.key,
  ...
  Widget _buildPriceRow(BuildContext context) {
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        if (resolved.price.showDiscountBadge && hasDiscount)
          Container(
  ...
  Widget? _buildInfoChips(BuildContext context) {
    ...
    if (resolved.meta.showStockHint) {
      ...
      if (qty > 0 && qty <= 10) {
        chips.add(const _CompactInfoChip(

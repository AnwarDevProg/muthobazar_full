// MB Product Card - premium05
//
// Family:
// Premium
//
// Purpose:
// A softer elegant premium family variant with a calmer content rhythm and
// lighter retail pressure. This version is useful for premium sections that
// should feel refined and trustworthy rather than strongly commercial.
//
// Footprint:
// Half-width card.
...
// 4. Price block
// 5. Soft support metadata
//
// Best Use Cases:
// Beauty, wellness, premium home products, imported food items,
// softer curated premium sections.
//
// Behavior Notes:
// - The calmest of the first Premium batch.
// - Lower urgency and softer visual weight.
// - Keeps the premium family elegant and breathable.
// - Gracefully handles missing subtitle, brand, and sale data.
...
class MBProductCardPremium05 extends StatelessWidget {
  const MBProductCardPremium05({
    super.key,

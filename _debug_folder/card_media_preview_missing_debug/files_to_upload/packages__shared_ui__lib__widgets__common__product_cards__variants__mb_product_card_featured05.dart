// MB Product Card - featured05
//
// Family:
// Featured
//
// Purpose:
// A softer elegant featured-family variant with calmer spacing and lower
// commercial pressure. This version is useful for featured rows that should
// feel more curated and editorial than sales-driven.
//
// Footprint:
// Full-width card.
// Tall footprint.
// Designed as a calm section anchor.
//
// Visual Priority:
// 1. Product image
// 2. Product title
...
//
// Best Use Cases:
// Editorial home sections, fresh and lifestyle categories, seasonal curation,
// softer hero placements, and calmer featured rows.
//
// Behavior Notes:
// - Softest and calmest of the first Featured batch.
// - Lower urgency and more breathing room.
// - Keeps the featured family important without feeling loud.
// - Gracefully handles missing subtitle, sale, and meta data.
...
class MBProductCardFeatured05 extends StatelessWidget {
  const MBProductCardFeatured05({
    super.key,

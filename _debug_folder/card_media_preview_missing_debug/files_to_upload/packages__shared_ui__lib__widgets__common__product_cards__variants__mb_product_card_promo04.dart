// MB Product Card - promo04
//
// Family:
// Promo
//
// Purpose:
// A coupon-style promo-family variant that presents the promotion like a more
// structured offer ticket while still showing the product clearly.
//
// Footprint:
// Full-width card.
// Medium footprint.
// Designed for offer-led campaign rows with stronger deal structure.
//
// Visual Priority:
// 1. Coupon / offer panel
// 2. Product image
// 3. Product title
// 4. Price block
// 5. CTA
//
// Best Use Cases:
// Coupon campaigns, wallet-style deals, basket offers, landing rows,
// and offer-led curated sections.
//
// Behavior Notes:
// - More offer-structured than promo01/02/03.
// - Still product-led overall.
// - Good for conversion-focused promotions.
// - Gracefully handles missing sale or offer data.
...
class MBProductCardPromo04 extends StatelessWidget {
  const MBProductCardPromo04({
    super.key,
  ...
  Widget build(BuildContext context) {
    final couponBox = _buildCouponBox(context);
  ...
  String? _couponText() {
    ...
    if (salePrice != null && salePrice < product.price) {
      ...
      return 'Coupon-style saving: ৳${saved.toStringAsFixed(0)}';
    }
    if (product.isFlashSale) return 'Limited coupon-style campaign';
    return 'Special promotional ticket';
  }

...
class MBAdvancedBindingRegistry {
  ...
  static const List<MBAdvancedBindingDefinition> definitions =
    ...
    MBAdvancedBindingDefinition(key: MBAdvancedBindingKey.productResolvedOriginalImageUrl, groupId: MBAdvancedBindingGroupId.product, label: 'Product original image URL', valueType: MBAdvancedBindingValueType.imageUrl),

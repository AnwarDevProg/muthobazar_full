...
class MBAdvancedElementCatalogV12 {
  ...
  static List<MBAdvancedElementGroup> groups() {
    return <MBAdvancedElementGroup>[
      ...
      _unitQuantityGroup(),
      _variationGroup(),
      _purchaseOptionGroup(),
      _attributeGroup(),
      _attributeValueGroup(),
      _attributePresetGroup(),
      _priceGroup(),
      _mrpGroup(),
      _discountGroup(),
      _promoGroup(),
  ...
  static MBAdvancedElementGroup _mediaGroup() {
    return _group('media', 'Media', 'Product, brand and category image sources', <MBAdvancedElementVariant>[
      _item(
        id: 'media_card_circle_ring',
        groupId: 'media',
        elementType: 'media',
        title: 'Card image circle',
        description: 'product.resolvedCardImageUrl',
        binding: MBAdvancedBindingKey.productResolvedCardImageUrl,
        x: 0.50,
        y: 0.42,
        z: 30,
        width: 173,
        height: 140,
        style: _mediaStyle(999, 7),
      ),
      _item(
        id: 'media_card_rounded',
        groupId: 'media',
        elementType: 'media',
        title: 'Card image rounded',
        description: 'product.resolvedCardImageUrl',
        binding: MBAdvancedBindingKey.productResolvedCardImageUrl,
        x: 0.50,
        y: 0.42,
      ...
      _item(
        ...
        elementType: 'media',
        title: 'Full image',
        description: 'product.resolvedFullImageUrl',
        binding: MBAdvancedBindingKey.productResolvedFullImageUrl,
        x: 0.50,
        y: 0.42,
        z: 30,
        width: 166,
        height: 132,
        style: _mediaStyle(20, 4),
      ),
      _item(
        id: 'media_thumb_image',
        groupId: 'media',
        elementType: 'media',
        title: 'Thumb image',
        description: 'product.resolvedThumbImageUrl',
        binding: MBAdvancedBindingKey.productResolvedThumbImageUrl,
        x: 0.22,
        y: 0.18,
        z: 32,
        width: 62,
        height: 62,
        style: _mediaStyle(999, 4),
      ),
  ...
  static MBAdvancedElementGroup _variationGroup() {
    return _group('variation', 'Variation', 'Selected variation fields', <MBAdvancedElementVariant>[
      _item(id: 'variation_title_en', groupId: 'variation', elementType: 'variation', title: 'Variation title EN', description: 'variation.titleEn', binding: MBAdvancedBindingKey.variationTitleEn, x: 0.48, y: 0.64, z: 38, width: 130, height: 24, style: _textStyle('#FFFFFF', 11, 'w800', 'left')),
      _item(id: 'variation_title_bn', groupId: 'variation', elementType: 'variation', title: 'Variation title BN', description: 'variation.titleBn', binding: MBAdvancedBindingKey.variationTitleBn, x: 0.48, y: 0.64, z: 38, width: 130, height: 24, style: _textStyle('#FFFFFF', 11, 'w800', 'left')),
      _item(id: 'variation_sku_chip', groupId: 'variation', elementType: 'variation', title: 'Variation SKU', description: 'variation.sku', binding: MBAdvancedBindingKey.variationSku, x: 0.36, y: 0.70, z: 38, width: 98, height: 24, style: _chipStyle('#FFFFFF', '#FF6500', 10, 'w900')),
      _item(id: 'variation_price_pill', groupId: 'variation', elementType: 'price', title: 'Variation price', description: 'variation.finalPrice', binding: MBAdvancedBindingKey.variationFinalPrice, x: 0.28, y: 0.84, z: 40, width: 96, height: 30, style: _chipStyle('#151922', '#FFFFFF', 13, 'w900')),
      _item(id: 'variation_stock_chip', groupId: 'variation', elementType: 'stock', title: 'Variation stock', description: 'variation.stockQty', binding: MBAdvancedBindingKey.variationStockQty, x: 0.34, y: 0.73, z: 38, width: 98, height: 25, style: _chipStyle('#FFFFFF', '#FF6500', 10, 'w900')),
      _item(id: 'variation_thumb_round', groupId: 'variation', elementType: 'media', title: 'Variation image', description: 'variation.thumbnailUrl', binding: MBAdvancedBindingKey.variationThumbnailUrl, x: 0.50, y: 0.42, z: 31, width: 150, height: 122, style: _mediaStyle(24, 4)),
      _item(id: 'variation_attribute_text', groupId: 'variation', elementType: 'variation', title: 'Variation attributes', description: 'variation.attributeSummary', binding: MBAdvancedBindingKey.variationAttributeSummary, x: 0.50, y: 0.76, z: 38, width: 150, height: 28, style: _textStyle('#FFF4E8', 10.5, 'w700', 'center')),
    ]);
  }

  static MBAdvancedElementGroup _purchaseOptionGroup() {
    return _group('purchase_option', 'Purchase Option', 'Selected pack/quantity option fields', <MBAdvancedElementVariant>[
      _item(id: 'purchase_option_label_en', groupId: 'purchase_option', elementType: 'purchaseOption', title: 'Option label EN', description: 'purchaseOption.labelEn', binding: MBAdvancedBindingKey.purchaseOptionLabelEn, x: 0.32, y: 0.69, z: 38, width: 106, height: 25, style: _chipStyle('#FFFFFF', '#FF6500', 10.5, 'w900')),
      _item(id: 'purchase_option_label_bn', groupId: 'purchase_option', elementType: 'purchaseOption', title: 'Option label BN', description: 'purchaseOption.labelBn', binding: MBAdvancedBindingKey.purchaseOptionLabelBn, x: 0.32, y: 0.69, z: 38, width: 106, height: 25, style: _chipStyle('#FFFFFF', '#FF6500', 10.5, 'w900')),
      _item(id: 'purchase_option_price', groupId: 'purchase_option', elementType: 'price', title: 'Option price', description: 'purchaseOption.finalPrice', binding: MBAdvancedBindingKey.purchaseOptionFinalPrice, x: 0.28, y: 0.84, z: 40, width: 98, height: 30, style: _chipStyle('#151922', '#FFFFFF', 13, 'w900')),
      _item(id: 'purchase_option_pack_text', groupId: 'purchase_option', elementType: 'purchaseOption', title: 'Pack text', description: 'purchaseOption.packText', binding: MBAdvancedBindingKey.purchaseOptionPackText, x: 0.50, y: 0.76, z: 38, width: 132, height: 25, style: _textStyle('#FFFFFF', 10.5, 'w800', 'center')),
      _item(id: 'purchase_option_unit', groupId: 'purchase_option', elementType: 'unit', title: 'Option unit', description: 'purchaseOption.unitLabelEn', binding: MBAdvancedBindingKey.purchaseOptionUnitLabelEn, x: 0.30, y: 0.72, z: 38, width: 82, height: 24, style: _chipStyle('#FFFFFF', '#FF6500', 10, 'w900')),
    ]);
  }

  static MBAdvancedElementGroup _attributeGroup() {
    return _group('product_attribute', 'Product Attribute', 'Attribute name/display fields', <MBAdvancedElementVariant>[
      _item(id: 'attribute_name_en', groupId: 'product_attribute', elementType: 'attribute', title: 'Attribute name EN', description: 'productAttribute.nameEn', binding: MBAdvancedBindingKey.productAttributeNameEn, x: 0.36, y: 0.70, z: 38, width: 112, height: 24, style: _textStyle('#FFFFFF', 10.5, 'w800', 'left')),
      _item(id: 'attribute_name_bn', groupId: 'product_attribute', elementType: 'attribute', title: 'Attribute name BN', description: 'productAttribute.nameBn', binding: MBAdvancedBindingKey.productAttributeNameBn, x: 0.36, y: 0.70, z: 38, width: 112, height: 24, style: _textStyle('#FFFFFF', 10.5, 'w800', 'left')),
      _item(id: 'attribute_display_chip', groupId: 'product_attribute', elementType: 'attribute', title: 'Attribute display', description: 'productAttribute.displayName', binding: MBAdvancedBindingKey.productAttributeDisplayName, x: 0.36, y: 0.70, z: 38, width: 112, height: 26, style: _chipStyle('#FFFFFF', '#FF6500', 10.5, 'w900')),
    ]);
  }

  static MBAdvancedElementGroup _attributeValueGroup() {
    return _group('attribute_value', 'Attribute Value', 'Selected attribute value fields', <MBAdvancedElementVariant>[
      _item(id: 'attribute_value_en', groupId: 'attribute_value', elementType: 'attributeValue', title: 'Value EN', description: 'attributeValue.valueEn', binding: MBAdvancedBindingKey.attributeValueTextEn, x: 0.58, y: 0.70, z: 38, width: 96, height: 24, style: _chipStyle('#FFFFFF', '#FF6500', 10.5, 'w900')),
      _item(id: 'attribute_value_bn', groupId: 'attribute_value', elementType: 'attributeValue', title: 'Value BN', description: 'attributeValue.valueBn', binding: MBAdvancedBindingKey.attributeValueTextBn, x: 0.58, y: 0.70, z: 38, width: 96, height: 24, style: _chipStyle('#FFFFFF', '#FF6500', 10.5, 'w900')),
      _item(id: 'attribute_value_color_dot', groupId: 'attribute_value', elementType: 'shape', title: 'Value color dot', description: 'attributeValue.colorHex', binding: MBAdvancedBindingKey.attributeValueColorHex, x: 0.82, y: 0.70, z: 39, width: 24, height: 24, style: <String, dynamic>{'backgroundHex': '#FF6500', 'borderRadius': 999.0}),
      _item(id: 'attribute_value_image', groupId: 'attribute_value', elementType: 'media', title: 'Value image', description: 'attributeValue.imageUrl', binding: MBAdvancedBindingKey.attributeValueImageUrl, x: 0.82, y: 0.16, z: 34, width: 42, height: 42, style: _mediaStyle(999, 3)),
    ]);
  }

  static MBAdvancedElementGroup _attributePresetGroup() {
    return _group('attribute_preset', 'Attribute Preset', 'Preset name/value/color/image fields', <MBAdvancedElementVariant>[
      _item(id: 'attribute_preset_name_en', groupId: 'attribute_preset', elementType: 'attributePreset', title: 'Preset name EN', description: 'attributePreset.nameEn', binding: MBAdvancedBindingKey.attributePresetNameEn, x: 0.36, y: 0.64, z: 38, width: 112, height: 24, style: _textStyle('#FFFFFF', 10.5, 'w800', 'left')),
      _item(id: 'attribute_preset_value_en', groupId: 'attribute_preset', elementType: 'attributePreset', title: 'Preset value EN', description: 'attributePreset.valueEn', binding: MBAdvancedBindingKey.attributePresetValueEn, x: 0.58, y: 0.70, z: 38, width: 96, height: 24, style: _chipStyle('#FFFFFF', '#FF6500', 10.5, 'w900')),
      _item(id: 'attribute_preset_color_dot', groupId: 'attribute_preset', elementType: 'shape', title: 'Preset color dot', description: 'attributePreset.colorHex', binding: MBAdvancedBindingKey.attributePresetColorHex, x: 0.82, y: 0.70, z: 39, width: 24, height: 24, style: <String, dynamic>{'backgroundHex': '#FF6500', 'borderRadius': 999.0}),
      _item(id: 'attribute_preset_image', groupId: 'attribute_preset', elementType: 'media', title: 'Preset image', description: 'attributePreset.imageUrl', binding: MBAdvancedBindingKey.attributePresetImageUrl, x: 0.82, y: 0.16, z: 34, width: 42, height: 42, style: _mediaStyle(999, 3)),
    ]);
  }

// MB Product Card - horizontal04
//
// Family:
// Horizontal
//
// Purpose:
// A richer information-row horizontal family variant that groups more product
// context into a cleaner lower structure. This version is useful when the row
// should explain slightly more without becoming a wide or featured card.
//
// Footprint:
// Full-width card.
...
// 1. Product image
// 2. Product title
// 3. Subtitle / description line
// 4. Price row
// 5. Grouped meta panel
//
// Best Use Cases:
// Recommendation rows with more explanation, curated subcategory rows,
// richer product lists, and information-heavier row layouts.
//
// Behavior Notes:
// - More informative than horizontal01/02/03.
// - Uses a lightweight grouped meta panel.
// - Still keeps the horizontal browsing rhythm intact.
// - Gracefully handles missing subtitle, brand, delivery, and stock data.
...
class MBProductCardHorizontal04 extends StatelessWidget {
  const MBProductCardHorizontal04({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final metaPanel = _buildMetaPanel(context);

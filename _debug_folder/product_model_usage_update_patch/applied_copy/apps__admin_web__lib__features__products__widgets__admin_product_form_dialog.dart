          ...
          if (_variations.isEmpty)
            ...
            Column(
              children: _variations
                  ...
                  subtitle: Text(
                    'enabled: ${item.isEnabled} Ã¢â‚¬Â¢ default: ${item.isDefault} Ã¢â‚¬Â¢ sort: ${item.sortOrder}',
                  ),
                ),
              )
    ...
    return SectionCard(
      ...
      child: _mediaItems.isEmpty
        ...
        children: _mediaItems
            ...
            subtitle:
            'role: ${item.role} Ã¢â‚¬Â¢ type: ${item.type} Ã¢â‚¬Â¢ primary: ${item.isPrimary} Ã¢â‚¬Â¢ order: ${item.sortOrder}',
    ...
    return SectionCard(
      ...
      child: _attributes.isEmpty
        ...
        children: _attributes
            ...
            title: item.nameEn,
            subtitle:
            'values: ${item.values.length} Ã¢â‚¬Â¢ variation: ${item.useForVariation} Ã¢â‚¬Â¢ order: ${item.sortOrder}',

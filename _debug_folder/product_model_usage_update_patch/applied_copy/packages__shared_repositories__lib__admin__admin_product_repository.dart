...
class AdminProductRepository {
  ...
  Future<MBProduct> prepareProductForWrite({
    ...
    final normalizedVariations = _normalizeVariationsForWrite(
      product.variations,
      actorUid: actorUid,
      isCreate: isCreate,
      now: now,
  ...
  List<MBProductVariation> _normalizeVariationsForWrite(
    ...
    return variations.map((variation) {
      return variation.copyWith(
        createdBy: isCreate ? actorUid : null,
        updatedBy: actorUid,
        createdAt: isCreate ? now : (variation.createdAt ?? now),
        updatedAt: now,
      );
